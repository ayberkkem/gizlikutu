document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateTimer() {
        ...
        const leftBtnHtml = `
            <div class="akhisar-promo-btn" style="background: linear-gradient(135deg, #e11d48 0%, #be123c 100%); color:#ffffff !important; padding:8px 16px; border-radius:12px; font-weight:700; font-size:14px; display:inline-flex; align-items:center; gap:8px; box-shadow:0 4px 10px rgba(225,29,72,0.3); cursor:default; white-space:nowrap;">
              <span style="color:#ffffff !important;">🏠 Akhisar'a Özel Kapıda Ödeme</span>
            </div>
        `;

        const rightBtnHtml = `
            <a href="https://wa.me/905400443445" target="_blank" class="akhisar-promo-btn" style="background: #25D366; color:#ffffff !important; padding:8px 16px; border-radius:12px; font-weight:700; font-size:14px; display:inline-flex; align-items:center; gap:8px; text-decoration:none; box-shadow:0 4px 10px rgba(37,211,102,0.3); transition: all 0.2s; white-space:nowrap;" onmouseover="this.style.transform='scale(1.02)'; this.style.boxShadow='0 6px 15px rgba(37,211,102,0.4)'" onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='0 4px 10px rgba(37,211,102,0.3)'">
              ...
              <span style="color:#ffffff !important;">WhatsApp Sipariş</span>
            </a>
        `;
